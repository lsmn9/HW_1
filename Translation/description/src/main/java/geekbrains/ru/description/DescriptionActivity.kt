package geekbrains.ru.description
...
class DescriptionActivity : AppCompatActivity() {
    ...
    private fun setData() {
        ...
        description_transcription.text = bundle?.getString(TRANSCRIPTION_EXTRA)
    ...
    companion object {
        ...
        private const val TRANSCRIPTION_EXTRA = "4z6a2w8a-ycdc-qwf1-ba89-7fe1017f63io"
